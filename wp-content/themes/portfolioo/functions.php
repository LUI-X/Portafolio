...
// Font size presets
function portfolioo_theme_setup_font_presets() {
	add_theme_support( 'editor-font-sizes', array(
    array(
        'name' => __( 'Small', 'portfolioo' ),
        'size' => 12,
        'slug' => 'small'
    ),
    array(
        'name' => __( 'Regular', 'portfolioo' ),
        'size' => 16,
        'slug' => 'regular'
    ),
    array(
        'name' => __( 'Large', 'portfolioo' ),
        'size' => 36,
        'slug' => 'large'
    ),
    array(
        'name' => __( 'Huge', 'portfolioo' ),
        'size' => 50,
        'slug' => 'huge'
	    )
	) );
...
add_action( 'after_setup_theme', 'portfolioo_theme_setup_font_presets' );


// add color palette support
function portfolioo_setup_theme_supported_color() {
    add_theme_support( 'editor-color-palette', array(
        array(
            'name' => __( 'Light Blue', 'portfolioo' ),
            'slug' => 'light-blue',
            'color' => '#d3e9f3',
        ),
        array(
            'name' => __( 'Material Green', 'portfolioo' ),
            'slug' => 'material-green',
            'color' => '#4CAF50',
        ),
        array(
            'name' => __( 'Light Gray', 'portfolioo' ),
            'slug' => 'light-gray',
            'color' => '#eee',
        ),
        array(
            'name' => __( 'Dark', 'portfolioo' ),
            'slug' => 'dark-gray',
            'color' => '#111',
	        ),
	    ) );
...
add_action( 'after_setup_theme', 'portfolioo_setup_theme_supported_color' );
